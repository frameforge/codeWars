<h2 align="center">codeWars Kata solution</h2>
...
You can click the `Edit in GitHub` button to open a pull request for quick fixes like typos, updates, or link fixes.
